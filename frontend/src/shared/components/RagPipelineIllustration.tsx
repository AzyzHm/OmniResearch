  ...
  return (
    ...
    >
      ...
      <g className="pipeline-router">
        <path
          d="M460,110 L480,130 L460,150 L440,130 Z"
          fill="var(--color-ink)"
          stroke="var(--color-teal)"
          strokeWidth="1.5"
        />
      ...
      <path
        className="pipeline-flow-main"
        d="M445,140 Q350,170 243,198"
        fill="none"
        stroke="var(--color-teal)"
        strokeWidth="1.5"
        opacity="0.55"
      />
      <path
        className="pipeline-flow-skip"
        d="M478,140 Q520,300 320,392"
        fill="none"
        stroke="var(--color-amber)"
        strokeWidth="1.2"
        opacity="0.35"
      ...
      <path
        className="pipeline-flow-retry"
        d="M347,300 Q260,320 220,260 Q210,240 220,220"
        fill="none"
        stroke="var(--color-amber)"
        strokeWidth="1.5"
        opacity="0.6"
